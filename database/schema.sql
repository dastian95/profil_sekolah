...
CREATE TABLE `pendaftar` (
  ...
  `kelurahan` varchar(100) DEFAULT NULL COMMENT 'Kelurahan domisili (zonasi Gelombang 2)',
  `jarak_km` decimal(5,2) DEFAULT NULL COMMENT 'Jarak garis lurus kelurahan ke sekolah (km)',
  `status_ortu` enum('tidak','yatim','piatu','yatim_piatu') NOT NULL DEFAULT 'tidak' COMMENT 'Status orang tua (Gelombang 2)',
  ...
  `nilai_tka` decimal(5,2) NOT NULL COMMENT 'Rata-rata TKA dari 2 mapel (bobot 30%)',
  `tka_mtk` decimal(5,2) DEFAULT NULL COMMENT 'Nilai TKA Matematika',
  `tka_bindo` decimal(5,2) DEFAULT NULL COMMENT 'Nilai TKA Bahasa Indonesia',
