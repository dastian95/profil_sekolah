...
// ── Sidebar meja global: muncul saat superadmin memegang meja ────────────────
$float_widget = null;
...
if ($fw_meja_id) {
    ...
    try {
        ...
        $fwc = $conn->prepare("SELECT * FROM antrian WHERE tanggal=? AND meja_id=? AND status='dipanggil' ORDER BY dipanggil_at DESC LIMIT 1");
...
<div class="offcanvas offcanvas-end f2-offcanvas" tabindex="-1" id="f2Sidebar">
    ...
    <div class="text-center py-3 px-2">
        ...
        <a href="superadmin_dashboard.php?page=pendaftar&add=1"
    ...
    <div class="px-3 pb-3 pt-1">
                ...
                <tr id="fwAct_<?= (int)$rw['id'] ?>" style="display:none;background:#f5f0ff;">
                    <td colspan="4" class="py-2">
                        <div class="d-flex gap-2 justify-content-end align-items-center">
                            ...
                            <form method="POST" action="superadmin_dashboard.php?page=antrian" class="d-inline" onsubmit="return confirm('Hapus pendaftar ini? Detail raport akan ikut terhapus.')">
        ...
        <a href="superadmin_dashboard.php?page=pendaftar&loket=<?= (int)$float_widget['meja']['id'] ?>" class="small text-decoration-none d-inline-block mt-2" style="color:#7c3aed;">
...
if (sidebar) {
    const sbKey = 'sidebar_scroll_super';
