...
<head>
    ...
    <style>
        @media print {
            ...
            .sidebar, .btn-print, .breadcrumb, #sidebarToggle {
        ...
        <div style="display: flex;">
            ...
            <div style="flex: 1;">
                <table style="width: 100%; font-size: 13px; border-collapse: collapse;">
                    <tr><td style="padding: 4px 0; font-weight: bold; width: 100px;">No. Peserta</td><td>: <?php echo 'U-' . $user_data['nisn']; ?></td></tr>
                    <tr><td style="padding: 4px 0; font-weight: bold;">Nama</td><td>: <?php echo htmlspecialchars($user_data['nama']); ?></td></tr>
                    <tr><td style="padding: 4px 0; font-weight: bold;">NISN</td><td>: <?php echo htmlspecialchars($user_data['nisn']); ?></td></tr>
                    <tr><td style="padding: 4px 0; font-weight: bold;">Jurusan</td><td>: <?php echo htmlspecialchars($jurusan); ?></td></tr>
                    <tr><td colspan="2" style="padding-top: 15px; font-weight: bold; text-decoration: underline;">Jadwal Ujian</td></tr>
                    <tr><td style="padding: 4px 0;">Hari/Tgl</td><td>: <?php echo $my_schedule['date']; ?></td></tr>
                    <tr><td style="padding: 4px 0;">Waktu</td><td>: <?php echo $my_schedule['time']; ?></td></tr>
                    <tr><td style="padding: 4px 0;">Lokasi</td><td>: <?php echo $my_schedule['location']; ?></td></tr>
                </table>
            </div>
        </div>
